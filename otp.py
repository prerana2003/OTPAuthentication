...
class otp_verifier(Tk):
    def __init__(self):
        ...
        self.client=Client("Account SID", "Auth Tocken")
        self.client.messages.create(to=["Your Activated Phone No"],
                                    from_ ="Your Twilio Phone No",
                                    body=self.n)
    ...
    def Buttons(self):
        ...
        self.resendOTP.place(x=209,y=400)
    ...
    def checkOTP(self):
        try:
            ...
            if self.userInput==self.n:
                ...
                messagebox.showinfo("showinfo", "Alreade Entered the OTP")
            else:
